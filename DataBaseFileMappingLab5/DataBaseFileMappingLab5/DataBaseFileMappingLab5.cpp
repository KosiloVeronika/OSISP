// DataBaseFileMappingLab5.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "DataBaseFileMappingLab5.h"
#include <vector>
#include <string>
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_DATABASEFILEMAPPINGLAB5, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_DATABASEFILEMAPPINGLAB5));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_DATABASEFILEMAPPINGLAB5));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_DATABASEFILEMAPPINGLAB5);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   hAdressEdit = CreateWindowEx(WS_EX_CLIENTEDGE, L"edit", L"hAdressEdit", WS_CHILD | WS_VISIBLE | ES_LEFT | ES_AUTOHSCROLL,
	   x + 100, y, w + 210, h, hWnd, (HMENU)ADRESS_EDIT, hInstance, NULL);
   ...
   SetWindowText(hTelephoneLabel, L"Телефон:");

   hTelephoneEdit = CreateWindowEx(WS_EX_CLIENTEDGE, L"edit", L"hTelephoneEdit", WS_CHILD | WS_VISIBLE | ES_LEFT | ES_NUMBER,
	   x + 100, y, w + 210, h, hWnd, (HMENU)TELEPHONE_EDIT, hInstance, NULL);
   SetWindowText(hTelephoneEdit, L"");

   y = 100;

   hFindAllButton = CreateWindow(L"button", L"hFindAllButton", WS_CHILD | WS_VISIBLE,
	   x - 20, y, w + 140, h, hWnd, (HMENU)RESULT_BUTTON, hInstance, NULL);
   SetWindowText(hFindAllButton, L"Поиск");
   ...
   hResultEdit = CreateWindowEx(WS_EX_CLIENTEDGE, L"edit", L"hResultEdit", WS_CHILD | WS_VISIBLE | ES_LEFT | ES_MULTILINE | ES_AUTOVSCROLL | WS_VSCROLL,
	   x - 20, y, 500, 330, hWnd, (HMENU)TELEPHONE_EDIT, hInstance, NULL);
